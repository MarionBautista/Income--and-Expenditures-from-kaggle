...
This chart simplifies a larger correlation matrix to show which spending categories are most strongly linked to household income. !(PNG/5.png)
...
This pie chart shows where Filipino households get their money. !(PNG/6.png)
...
This chart shows how many members are in an average Filipino family. !(PNG/7.png)
